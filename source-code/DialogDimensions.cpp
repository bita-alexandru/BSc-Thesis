...
DialogDimensions::DialogDimensions(wxWindow* parent) : wxDialog(parent, wxID_ANY, "Change Grid Dimensions")
{
	...
	m_SpinRows = new wxSpinCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, 1, 500, 1);
	...
	m_SpinCols = new wxSpinCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS | wxSP_WRAP, 1, 500, 1);
